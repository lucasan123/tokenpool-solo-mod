  ...
  async processQueuedShares(mongoInterface, poolConfig)
  {
    ...
    if(typeof shareData != 'undefined' && shareData != null)
    {
      ...
      try{
        ...
        {
          console.error('errore mongodb a processarel le shares')
console.error(['handle share error',err], LoggingHelper.TYPECODES.ERROR, mongoInterface)
...
/* 
   ...
   */
   ...
   static async handlePeerShareSubmit(shareData ,mongoInterface, poolConfig)
   {
    ...
    // var varDiff =  getUpdatedVarDiffForMiner(minerEthAddress);
...
var numeroerroridigest1= contaerroridigest1()

if (numeroerroridigest1 % 5 == 0) { console.log('5 errore bad digest, totale di  ' + numeroerroridigest1+ ' errori') }
}
//, computed_digest, digest
       if(difficulty < minShareDifficulty)  {
var numeroerroridiff2= contaerroridiff2()
if (numeroerroridiff2 % 5 == 0) { console.log('5 errore bad diff num, totale di  ' + numeroerroridiff2 + ' errori')
}
}
//', difficulty, minShareDifficulty
       if( digestBigNumber.lt(minShareTarget) == false) {
var numeroerrori3= contaerrori3()
if (numeroerrori3 % 5 == 0) { console.log('5 errori target rilevati , totale di  ' + numeroerrori3 + ' errori') }
}
//, digestBigNumber.toString(), minShareTarget.toString(), poolMinDiff.toString()
  ...
  static async  handleValidShare( nonce,minerEthAddress,digest,difficulty, shareIsASolution, mongoInterface, poolConfig )
   {
      ...
      { 
       ...
       //  await PeerHelper.saveMinerDataToRedisMongo(minerEthAddress,minerData, mongoInterface)
        ...
        await PeerHelper.awardTokensBalanceForShares( minerEthAddress, shareCredits, poolConfig, mongoInterface )
        ...
        var numerosoluzioni = contasoluzione()
        console.log(' soluzione trovata , questa è la soluzione numero ' +  numerosoluzioni) 
...
async getUpdatedVarDiffForMiner(sharesData,minerAddress)
   {
	...
	//console.log(minerVarDiff )
//console.log ('miner var diff')
      return minerVarDiff;
   }
...
*/
  ...
  async initJSONRPCServer()
 	...
 	console.log(' questo è quanto')
	//console.log(poolConfig.miningConfig.allowCustomVardiff == true)
		...
		//console.log('Non e stata immessa vardiff ')
          }
...
console.log('errore nell immettere la share')
}
          ...
          var ethBlock = await TokenDataHelper.getEthBlockNumber(mongoInterface);
//console.log('blocco polygon')
	//console.log(await TokenDataHelper.getEthBlockNumber(mongoInterface));
//	console.log('blocco polygon2')
	...
	//console.log(minShareDifficulty + 'minsharediff')
	...
	//console.log( [ 'adding share to queued shares list', computed_digest, digest], LoggingHelper.TYPECODES.SHARES, mongoInterface)
	//console.log('share aggiunta alla coda')
//var nuh = 1;
var numeroshare= countshares()
if (numeroshare % 50 == 0) { console.log('50 shares aggiunte alla coda , questa è la share numero ' +  numeroshare) }
...
var countshares = (function (b)  {
return function() {
 b += 1;
	//console.log('share numero ' + b)
    return b;
  }
}(0));
	...
	var contaerroridigest1 =(function (s)  {
return function() {
 s += 1;
	//console.log('soluzione numero ' + d)
    return s;
  }
}(0));

	var contaerroridiff2 =(function (y)  {
return function() {
 y += 1;
	//console.log('soluzione numero ' + d)
    return y;
	...
	var contaerrori3 =(function (e)  {
return function() {
 e += 1;
	//console.log('soluzione numero ' + e)
    return e;
  }
}(0));