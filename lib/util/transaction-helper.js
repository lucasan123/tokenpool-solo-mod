...
/*
  ...
  try{
   ...
   var addressTo = tokenContract.options.address;
	...
	var numerorevert = contarevert()
      console.log('Rilevata una transazione che va in revert, numero ' + numerorevert)
	//console.log( ['estimatedGasCostError', error], LoggingHelper.TYPECODES.ERROR, mongoInterface)
...
/*   
    ...
    if(transactionType == "0x02"){
      ...
      console.log('txOptions.gasPrice',paymentsGasPriceWei  )
    }
