...
*/
   ...
   if(txType=="solution"){
	...
	console.log(['submitresult ', submitResult ], LoggingHelper.TYPECODES.TRANSACTIONS, mongoInterface)
 ...
 //           return false;
  //        }
      ...
      //    var submitResult =   await TransactionHelper.submitBatchedPayment(txData, mongoInterface, poolConfig)
          ...
          console.log('fucking batched payment ' )
 	return false;
...
//          if(submitResult.success == true){
  ...
  //          tx_hash = submitResult.txResult.txHash 
    ...
    if(tx_hash == null){
      console.error('Tx not broadcast successfully')
//,txType,txData 
